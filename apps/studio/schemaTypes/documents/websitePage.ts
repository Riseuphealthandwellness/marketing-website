...
export const websitePage = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'string',
      description: 'Shown only on pages that list documents, such as Locations.',
      group: 'pageSpecific',
      hidden: ({document}) => document?.key !== 'locations',
    }),
    defineField({
      name: 'services',
      title: 'Services',
